...
module RIO
  module Ops
    autoload :Path, 'rio/ops/path'
    autoload :Dir, 'rio/ops/dir'
    autoload :File, 'rio/ops/file'
    autoload :Stream, 'rio/ops/stream'
    autoload :Symlink, 'rio/ops/symlink'
    autoload :FileOrDir, 'rio/ops/either'
  end
end
