...
module RDoc::Generator::HTML::RIOWEB
...
#tab-bodies h1, #tab-bodies h2, #tab-bodies h3, #tab-bodies h4 {
  margin: 0;
...
#tab-bodies h2,#tab-bodies h3,#tab-bodies h4 {
  margin-top: 1em;
}

#tab-bodies :link, #tab-bodies :visited {
  background: #eef;
  color: #039;
  text-decoration: none;
}

#tab-bodies :link:hover, #tab-bodies :visited:hover {
  background: #039;
  color: #eef;
}
...
#####################################################################
  ...
  HEADER = XHTML_STRICT_PREAMBLE + HTML_ELEMENT + %{
<head>
...
#####################################################################
  ...
  SRC_PAGE = XHTML_STRICT_PREAMBLE + HTML_ELEMENT + %{
<head>
  <title><%= values["title"] %></title>
  <meta http-equiv="Content-Type" content="text/html; charset=<%= values["charset"] %>" />
...
#####################################################################
  ...
  FILE_INDEX = XHTML_STRICT_PREAMBLE + HTML_ELEMENT + %{
<!--
...
<% end %><%#  values["entries"] %>
  ...
  INDEX = XHTML_STRICT_PREAMBLE + HTML_ELEMENT + %{
<!--
...
<head>
  ...
  <body>
	...
	<li><a href="classes/RIO/Rio.html"><span>Rio</span></a></li>
	<li><a href="classes/RIO.html"><span>RIO</span></a></li>
	<li><a href="classes/RIO/Doc/INTRO.html"><span>INTRO</span></a></li>
	<li><a href="classes/RIO/IF/GrandeEntry.html"><span>Grande Entry</span></a></li>
	<li><a href="classes/RIO/IF/Grande.html"><span>Grande</span></a></li>
      </ul>
      <div id="tab-bodies">
